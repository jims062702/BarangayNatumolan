...
class SetSlotCommand(Command):
    ...
    def run_command_on_tracker(
        ...
        if isinstance(top_frame, CollectInformationPatternFlowStackFrame):
            ...
            # The user is answering a validation re-prompt for this slot, so the
            # extractor must be allowed to fill it even when ask_before_filling=True.
            slots_of_active_flow.add(top_frame.validate)
