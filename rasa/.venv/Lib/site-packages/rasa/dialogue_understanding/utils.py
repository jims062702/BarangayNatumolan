...
from rasa.core.constants import LLM_TOTAL_TIME_MS_KEY
...
def add_prompt_to_message_parse_data(
    ...
    llm_response_metadata: Optional[Dict[Text, Any]] = None
    if llm_response is not None:
        llm_response_metadata = llm_response.to_dict()
        if llm_response.latency is not None:
            llm_response_metadata[LLM_TOTAL_TIME_MS_KEY] = llm_response.latency * 1000
