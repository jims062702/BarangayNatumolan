...
INTERNAL_ERROR_SOURCE_PRE_CALL_HOOK = "pre_call_hook"
"""Value for ``info["error_source"]`` when a call-time credential hook failed."""
...
class InternalErrorPatternFlowStackFrame(PatternFlowStackFrame):
    ...
    def from_dict(data: Dict[str, Any]) -> InternalErrorPatternFlowStackFrame:
        ...
        """
        require_keys(
            data, "frame_id", "step_id", context="Internal error pattern frame"
        )
