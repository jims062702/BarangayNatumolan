...
from rasa.shared.constants import ACTION_ASK_PREFIX, RASA_DEFAULT_FLOW_PATTERN_PREFIX
...
class CollectInformationPatternFlowStackFrame(PatternFlowStackFrame):
    ...
    def from_dict(data: Dict[str, Any]) -> CollectInformationPatternFlowStackFrame:
        ...
        require_keys(
            ...
            "collect",
            "utter",
            context="Collect information pattern frame",
        )
        ...
        return CollectInformationPatternFlowStackFrame(
            ...
            collect=data["collect"],
            collect_action=data.get("collect_action", f"{ACTION_ASK_PREFIX}{collect}"),
            utter=data["utter"],
