...
class SingleStepBasedLLMCommandGenerator(LLMBasedCommandGenerator, ABC):
    ...
    @observe(
        name="command_generator.single_step",
        as_type="generation",
        capture_input=False,
    ...
    async def _predict_commands(
        ...
        update_current_span_metadata(
            metadata={
                "prompt_type": "command_generation",
                "command_generator": self.__class__.__name__,
                "sender_id": tracker.sender_id if tracker else None,
                "message_text_length": len(message.get(TEXT, "")),
            }
        )
