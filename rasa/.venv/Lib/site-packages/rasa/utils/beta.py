"""Gating for released, customer-facing beta functionality.

See also `rasa.utils.feature_flags` for temporary, internal-only flags
that gate in-progress (not yet released) code — a different mechanism
from the permanent, customer-facing beta gate below.
"""
