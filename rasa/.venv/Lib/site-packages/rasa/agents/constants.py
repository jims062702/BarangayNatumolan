...
ASYNC_AGENT_PROCESSING_TIMEOUT_SECONDS = 60 * 60
...
AGENT_METADATA_RESTARTED_KEY = "restarted"
AGENT_METADATA_SENDER_ID_KEY = "sender_id"
AGENT_METADATA_AGENT_ID_KEY = "agent_id"
AGENT_METADATA_MODEL_ID_KEY = "model_id"
AGENT_METADATA_CANCELLATION_REASON_KEY = "cancellation_reason"
# A2A-specific constants
A2A_AGENT_CONTEXT_ID_KEY = "context_id"
A2A_AGENT_TASK_ID_KEY = "task_id"
A2A_TASK_POLLING_INITIAL_DELAY = 0.5
A2A_TASK_POLLING_MAX_WAIT = 60
A2A_CANCELLATION_REASON_POLLING = "Polling cancelled"
A2A_CANCELLATION_REASON_STREAMING = "Streaming cancelled"
