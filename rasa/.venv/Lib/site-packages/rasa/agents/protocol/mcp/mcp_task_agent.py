...
from rasa.shared.core.slot_mappings import slot_mappings_allow_llm_fill
...
class MCPTaskAgent(MCPBaseAgent):
    ...
    def get_agent_specific_built_in_tools(
        ...
        return [
            ...
            if slot_mappings_allow_llm_fill(slot.mappings)
        ]
    ...
    def render_prompt_template(self, context: AgentInput) -> str:
        ...
        slots_by_name = {slot.name: slot for slot in context.slots}
        template_vars["slot_names"] = [
            slot_name
            for slot_name in slot_names
            if slot_mappings_allow_llm_fill(slots_by_name[slot_name].mappings)
        ]
