...
DOCS_REFERENCE_BASE_URL = "https://rasa.com/docs/reference"
# Kept for backward compat; derived constants now use DOCS_REFERENCE_BASE_URL directly.
...
DOCS_URL_SLOTS = DOCS_REFERENCE_BASE_URL + "/config/domain#slots"
DOCS_URL_RESPONSES = DOCS_REFERENCE_BASE_URL + "/primitives/responses"
DOCS_URL_POLICIES = DOCS_REFERENCE_BASE_URL + "/config/policies/overview"
DOCS_URL_ACTIONS = DOCS_REFERENCE_BASE_URL + "/primitives/actions"
DOCS_URL_DEFAULT_ACTIONS = DOCS_REFERENCE_BASE_URL + "/primitives/default-actions"
DOCS_URL_COMPONENTS = DOCS_REFERENCE_BASE_URL + "/overview"
DOCS_URL_GRAPH_COMPONENTS = DOCS_URL_CONCEPTS + "/components/custom-graph-components"
DOCS_URL_GRAPH_RECIPE = DOCS_REFERENCE_BASE_URL + "/config/components/graph-recipe"
DOCS_URL_CATEGORICAL_SLOTS = DOCS_REFERENCE_BASE_URL + "/config/domain#categorical-slot"
DOCS_URL_DOMAIN = DOCS_REFERENCE_BASE_URL + "/config/domain"
DOCS_URL_FLOWS = DOCS_REFERENCE_BASE_URL + "/primitives/flows"

# Docs URLs for NLU-based assistants
DOCS_URL_TRAINING_DATA = DOCS_REFERENCE_BASE_URL + "/primitives/training-data-format"
DOCS_URL_TRAINING_DATA_NLU = DOCS_URL_TRAINING_DATA + "#nlu-training-data"
DOCS_URL_DOMAINS = DOCS_REFERENCE_BASE_URL + "/config/domain"
...
# No standalone reference page; covered under CALM + NLU coexistence.
DOCS_URL_STORIES = "https://rasa.com/docs/pro/calm-with-nlu/coexistence/"
...
DOCS_URL_NLU_BASED_POLICIES = DOCS_REFERENCE_BASE_URL + "/config/policies/overview"

# Other docs URLs
DOCS_URL_MARKERS = DOCS_REFERENCE_BASE_URL + "/integrations/analytics"
DOCS_URL_CONNECTORS = DOCS_REFERENCE_BASE_URL + "/channels/messaging-and-voice-channels"
DOCS_URL_CONNECTORS_SLACK = DOCS_REFERENCE_BASE_URL + "/channels/slack"
DOCS_URL_EVENT_BROKERS = DOCS_REFERENCE_BASE_URL + "/integrations/event-brokers"
DOCS_URL_PIKA_EVENT_BROKER = DOCS_URL_EVENT_BROKERS + "#pika-event-broker"
DOCS_URL_TRACKER_STORES = DOCS_REFERENCE_BASE_URL + "/integrations/tracker-stores"
DOCS_URL_MIGRATION_GUIDE = (
    DOCS_REFERENCE_BASE_URL + "/changelogs/rasa-pro-migration-guide"
)
DOCS_URL_TELEMETRY = DOCS_REFERENCE_BASE_URL + "/telemetry"
DOCS_URL_HTTP_API = DOCS_REFERENCE_BASE_URL + "/api/pro/http-api"
DOCS_URL_HTTP_API_SECURITY = DOCS_URL_HTTP_API + "#security-considerations"
DOCS_URL_ACTION_SERVER = DOCS_REFERENCE_BASE_URL + "/integrations/action-server/actions"
DOCS_URL_MODEL_STORAGE = DOCS_REFERENCE_BASE_URL + "/integrations/model-storage"
...
ASSERTIONS_SCHEMA_FILE = "e2e_test/schema/assertions_schema.yml"
...
DEFAULT_START_SESSION_AFTER_EXPIRY = True
...
RIME_API_KEY_ENV_VAR = "RIME_API_KEY"
NEUPHONIC_API_KEY_ENV_VAR = "NEUPHONIC_API_KEY"
...
DEFAULT_INCLUDE_DATE_TIME = True
...
RASA_PATTERN_SEARCH = "pattern_search"
RASA_PATTERN_CUSTOMER_SATISFACTION = "pattern_customer_satisfaction"
