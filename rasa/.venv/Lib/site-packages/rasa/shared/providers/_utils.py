...
def _validate_credentials_with_aws_client(
    ...
    try:
        ...
        streaming_note = (
            " If you are using the Rephraser (nlg.type: rephrase) or any other"
            " streaming feature, your IAM policy must also include"
        ...
        event_info = (
            ...
            f"Also, ensure that the AWS region is set correctly.{streaming_note}"
        )
        structlogger.error(
...
def validate_azure_client_setup(
    ...
    """Validates the Azure setup for LiteLLM Router clients.

    Ensures that all required configuration parameters are set.
    ...
    def generate_event_info_for_missing_setting(
        ...
        """Generate instructions for a missing client setting.

        Returns a message fragment describing which environment variable or
        config key to set.
        """
