...
class _BaseLiteLLMEmbeddingClient:
    ...
    def _litellm_extra_parameters(self) -> Dict[str, Any]:
        """Returns a dictionary of extra LiteLLM parameters.

        Includes model parameters and LiteLLM-specific input parameters.
    ...
    def validate_client_setup(self) -> None:
        ...
        By default only environment variables are validated. Override this
        method to add more validation steps.
    ...
    def embed(self, documents: List[str], **kwargs: Any) -> EmbeddingResponse:
        ...
        Args:
            ...
            **kwargs: Additional parameters passed to the embedding call.
    ...
    def _ensure_certificates() -> None:
        ...
        Invoked during client initialization. LiteLLM may utilize `openai` clients
        or other providers that require
