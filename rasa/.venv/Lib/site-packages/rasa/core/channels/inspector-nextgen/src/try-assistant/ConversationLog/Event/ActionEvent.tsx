...
import { ClockRotateLeft, Code, Ear } from "../../../Icon/icons";
...
export const ActionEvent = forwardRef<HTMLDivElement | null, ActionEventProps>(
  (props: ActionEventProps, ref) => {
    ...
    const actionLabel = event.name === ACTION_LISTEN_NAME ? "Waiting for user input" : event.name;

    const handleReplayClick = (mouseEvent: React.MouseEvent<HTMLButtonElement>) => {
