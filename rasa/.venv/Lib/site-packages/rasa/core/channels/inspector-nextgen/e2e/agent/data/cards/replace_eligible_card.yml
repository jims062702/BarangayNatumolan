  ...
  replace_eligible_card:
    ...
    steps:
      - collect: replacement_reason
        description: "Indicates why the user needs to replace their card: lost, damaged, or reason unknown."
        next:
          - if: slots.replacement_reason == "lost"
            then:
              - collect: was_card_used_fraudulently
                description: "Indicates whether the card has been used for unauthorized or fraudulent transactions; accepts True or False, yes or no."
