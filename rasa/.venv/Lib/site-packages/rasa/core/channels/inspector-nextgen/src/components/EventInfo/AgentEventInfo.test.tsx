...
describe("AgentEventInfo", () => {
  it("renders the title", () => {
    renderWithProviders(<AgentEventInfo event={baseEvent} onClose={vi.fn()} />);
  ...
  it("calls onClose when close button is clicked", () => {
    const onClose = vi.fn();
    renderWithProviders(<AgentEventInfo event={baseEvent} onClose={onClose} />);
  ...
  describe("agent name", () => {
    ...
    it("falls back to event.name when agentId is absent", () => {
      ...
      renderWithProviders(<AgentEventInfo event={event} onClose={vi.fn()} />);
  ...
  describe("trigger section", () => {
    it("shows flow ID in trigger text", () => {
      ...
      expect(screen.getByText(/This sub-agent was triggered by flow banking/)).toBeInTheDocument();
    });
  ...
  describe("description section", () => {
    it("renders description when present in metadata", () => {
      ...
      expect(screen.getByText("Handles banking queries")).toBeInTheDocument();
    });
