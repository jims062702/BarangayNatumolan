...
describe("VoiceButton", () => {
  ...
  it.each([
    ...
    ({ state, expectedLabel, shouldBeDisabled }) => {
      renderWithProviders(
        <VoiceButton voiceCallState={state} startCall={startCall} stopCall={stopCall} />,
      );
  ...
  it("should call startCall when inactive button is clicked", async () => {
    ...
    renderWithProviders(
      <VoiceButton voiceCallState="inactive" startCall={startCall} stopCall={stopCall} />,
    );
  ...
  it("should call stopCall when active button is clicked", async () => {
    const user = userEvent.setup();
    renderWithProviders(
      <VoiceButton voiceCallState="active" startCall={startCall} stopCall={stopCall} />,
    );
