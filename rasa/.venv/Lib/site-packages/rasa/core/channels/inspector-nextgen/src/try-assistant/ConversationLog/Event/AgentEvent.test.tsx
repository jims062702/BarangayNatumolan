...
describe("AgentEvent", () => {
  describe("agent name display", () => {
    it("uses agentId from event", () => {
      renderWithProviders(<AgentEvent event={baseEvent} isSelected={false} />);
    ...
    it("falls back to event.name when agentId is absent", () => {
      ...
      renderWithProviders(<AgentEvent event={event} isSelected={false} />);
  ...
  describe("interaction", () => {
    it("calls onClick when clicked", () => {
      ...
      renderWithProviders(<AgentEvent event={baseEvent} isSelected={false} onClick={onClick} />);
    ...
    it("calls onKeyDown when a key is pressed", () => {
      ...
      renderWithProviders(
        <AgentEvent event={baseEvent} isSelected={false} onKeyDown={onKeyDown} />,
      );
  ...
  describe("hover actions", () => {
    ...
    it("does not show action button when not hovered", () => {
      renderWithProviders(
        <AgentEvent event={baseEvent} isSelected={false} conversationEventActions={actions} />,
      );
