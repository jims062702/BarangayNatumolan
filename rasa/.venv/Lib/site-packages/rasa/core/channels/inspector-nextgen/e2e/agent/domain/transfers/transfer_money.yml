...
responses:
  utter_ask_transfer_type:
    ...
    - text: Would you like to make a third party domestic transfer or just move money between your accounts?
  ...
  utter_ask_transfer_timing_type:
    ...
    - text: Would you like this transfer to execute immediately, schedule it for a later date or actually set it up as a new recurring payment?
      channel: "browser_audio"
  ...
  utter_ask_recurrent_payment_type:
    ...
    - text: Should this payment be a direct debit or is it a standing order?
      channel: "browser_audio"
  ...
  utter_ask_recurrent_payment_frequency:
    ...
    - text: "Should this recurring payment be done once every week, once every month or once every year?"
      channel: "browser_audio"
  ...
  utter_ask_immediate_transfer_confirmation:
    ...
    - text: |
        You’re about to perform an instant transfer of {amount_of_money} dollars to {recipient_account}.
        Do you want to proceed?
      channel: "browser_audio"

  utter_ask_setup_scheduled_transfer_confirmation:
    - text: |
        You’re scheduling a transfer of {amount_of_money} dollars to {recipient_account} on {date} at {time}.
        Do you want to proceed?
      buttons:
        - payload: /SetSlots(confirmation=true)
          title: "Yes"
    ...
    - text: |
      ...
      buttons:
        ...
        - payload: /SetSlots(confirmation=false)
          title: "No, cancel the transfer"
    - text: |
        You’re setting up a recurring {recurrent_payment_type} to transfer {amount_of_money} dollars to {recipient_account}.
        The payment will be made {recurrent_payment_frequency}, starting on {date_range_start} and ending on {date_range_end}.
        Do you want to proceed?
      channel: "browser_audio"
  ...
  utter_ask_self_transfer_final_confirmation:
    - text: |
        You're about to transfer {amount_of_money} dollars from your {self_transfer_source_account} to {self_transfer_destination_account}.
        Do you want to proceed?
      buttons:
        - payload: /SetSlots(confirmation=true)
          title: "Yes"
  ...
  utter_self_transfer_completed:
    - text: Successfully transferred {amount_of_money} dollars from {self_transfer_source_account} to {self_transfer_destination_account}.

  utter_transfer_failed:
    - text: Something went wrong. Couldn't complete the transfer.

  utter_transfer_completed:
    - text: Successfully transferred {amount_of_money} dollars to {recipient_account}.

  utter_transfer_cancelled:
    - text: Okay cancelling the transfer.

  utter_schedule_transaction_complete:
    - text: Transfer has been scheduled.

  utter_recurring_payment_setup_complete:
    - text: Your recurring payment to {recipient_account} has been set up.
