import { type EdgeProps, BaseEdge, getSmoothStepPath, Position } from "reactflow";
...
function getEdgeCoordinatesAndPosition({
  ...
  if (sourceNode.metadata.y === targetNode.metadata.y && calculatedSourceX < calculatedTargetX) {
    calculatedSourcePosition = Position.Right;
    calculatedTargetPosition = Position.Left;
    calculatedSourceX = sourceX + sourceNodeWidth / 2;
    calculatedSourceY = sourceY - nodeHeight / 2;
  ...
  if (sourceNode.metadata.x === targetNode.metadata.x && calculatedSourceY > calculatedTargetY) {
    calculatedSourcePosition = Position.Left;
    calculatedTargetPosition = Position.Left;
    calculatedSourceX = sourceX - sourceNodeWidth / 2;
    calculatedSourceY = sourceY - nodeHeight / 2;
...
export const CustomEdge = (props: EdgeProps) => {
  ...
  return (
    <g data-testid={selected ? "edge-selected" : undefined}>
