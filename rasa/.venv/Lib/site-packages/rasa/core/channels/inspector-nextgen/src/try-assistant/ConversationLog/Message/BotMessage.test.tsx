...
vi.mock("../../../RasaCodeBlock", () => ({
  RasaCodeBlock: ({ code }: { code: string }) => <pre data-testid="code-block">{code}</pre>,
}));
...
describe("BotMessage", () => {
  describe("text rendering", () => {
    it("renders the utterance text", () => {
      renderWithProviders(<BotMessage utterance={baseUtterance} inspectorMode={false} />);
      expect(screen.getByText("Hello there!")).toBeInTheDocument();
    });

    it("does not render a text node when text is empty", () => {
      const utterance = { ...baseUtterance, text: "" };
      renderWithProviders(<BotMessage utterance={utterance} inspectorMode={false} />);
  ...
  describe("buttons and quick replies", () => {
    ...
    it("disables buttons when isInteractive is false", () => {
      ...
      renderWithProviders(
        <BotMessage utterance={utterance} isInteractive={false} inspectorMode={false} />,
      );
  ...
  describe("custom JSON payload", () => {
    ...
    it("shows the JSON label when custom is provided", () => {
      renderWithProviders(<BotMessage utterance={utteranceWithCustom} inspectorMode={false} />);
