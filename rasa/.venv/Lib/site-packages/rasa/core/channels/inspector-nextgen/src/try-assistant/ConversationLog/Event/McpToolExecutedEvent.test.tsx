...
describe("McpToolExecutedEvent", () => {
  describe("tool name display", () => {
    it("uses tool_name from metadata", () => {
      renderWithProviders(<McpToolExecutedEvent event={baseEvent} isSelected={false} />);
    ...
    it("falls back to event.name when metadata.tool_name is absent", () => {
      ...
      renderWithProviders(<McpToolExecutedEvent event={event} isSelected={false} />);
  ...
  describe("interaction", () => {
    it("calls onClick when clicked", () => {
      ...
      renderWithProviders(
        <McpToolExecutedEvent event={baseEvent} isSelected={false} onClick={onClick} />,
      );
    ...
    it("calls onKeyDown when a key is pressed", () => {
      ...
      renderWithProviders(
        <McpToolExecutedEvent event={baseEvent} isSelected={false} onKeyDown={onKeyDown} />,
      );
