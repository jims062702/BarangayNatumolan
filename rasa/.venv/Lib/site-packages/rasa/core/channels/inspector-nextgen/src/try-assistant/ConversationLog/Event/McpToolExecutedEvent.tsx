...
export const McpToolExecutedEvent = forwardRef<HTMLDivElement | null, McpToolExecutedEventProps>(
    ...
    return (
      ...
      >
        ...
        <Box css={baseMessageSx}>
          ...
          <Text textStyle="xs" lineClamp={2} wordBreak="break-all" variant="muted">
            Tool{" "}
