...
export const useConversationData = () => {
  ...
  const authToken = useInspectorStore((s) => s.authToken);
  ...
  const {
    ...
    queryKey: ["botData", projectUrl, botDataEndpoint, authToken],
    queryFn: () => getBotData({ projectUrl, botDataEndpoint, authToken }),
    enabled: !!projectUrl,
