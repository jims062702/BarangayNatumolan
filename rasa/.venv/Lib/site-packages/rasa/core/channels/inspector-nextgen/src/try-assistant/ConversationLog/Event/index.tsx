...
import { TtsFinishedEvent } from "./TtsFinishedEvent";
...
const slotEventTypes = [ConversationEventType.Slot, ConversationEventType.ResetSlots];
...
export const Event = forwardRef<HTMLDivElement | null, Props>((props: Props, ref) => {
  const {
    event,
    selectable = false,
    onEventSelect,
  ...
  if (event.conversationEventType === ConversationEventType.BotTurnEnded) {
    return (
      <BotTurnEndedEvent
        ref={ref}
        event={event}
  ...
  if (event.conversationEventType === ConversationEventType.TtsFinished) {
    return (
      <TtsFinishedEvent
        ref={ref}
        event={event}
