...
import { PlaceholderImage, type Conversation, type Flow, type Stack } from "../types";
...
export const FlowSection = ({
  ...
  return (
    <FlowErrorBoundary
      ...
      onError={(err) =>
        logError(err, {
          tags: { component: "FlowSection", action: "renderFlow" },
        })
      }
    >
      <FlowComponent
        ...
        conversation={
          conversationForSelectedElement || conversationList[conversationList.length - 1]
        }
      />
    </FlowErrorBoundary>
  );
