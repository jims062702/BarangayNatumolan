...
export function EventAccordionItem({ title, value, children }: EventAccordionItemProps) {
  return (
    <Accordion.Item value={value} borderBottom="1px solid" borderColor="border" py="1">
