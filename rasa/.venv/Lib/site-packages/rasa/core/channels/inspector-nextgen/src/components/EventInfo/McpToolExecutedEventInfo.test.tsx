...
describe("McpToolExecutedEventInfo", () => {
  it("renders the title", () => {
    renderWithProviders(<McpToolExecutedEventInfo event={baseEvent} onClose={vi.fn()} />);
  ...
  it("calls onClose when close button is clicked", () => {
    const onClose = vi.fn();
    renderWithProviders(<McpToolExecutedEventInfo event={baseEvent} onClose={onClose} />);
  ...
  describe("tool name", () => {
    ...
    it("falls back to rawEvent.tool_name when metadata.tool_name is absent", () => {
      ...
      renderWithProviders(<McpToolExecutedEventInfo event={event} onClose={vi.fn()} />);
  ...
  describe("error section", () => {
    it("shows error section instead of result when tool_is_error is true", () => {
      ...
      expect(
        screen.getByText("This tool call failed to execute due to the following reason:"),
      ).toBeInTheDocument();
