...
export const MessageMarkup = forwardRef<HTMLDivElement | null, Props>((props: Props, ref) => {
  const {
    utterance,
    isSelected,
    isHighlighted,
  ...
  const showAvatar =
    !(utterance && isBotUtteranceEmpty(utterance)) && utteranceType !== previousUtterance?.type;
  ...
  const messageSxColor =
    isUser || (!isInteractive && isHighlighted) ? highlightTextColor : regularTextColor;
