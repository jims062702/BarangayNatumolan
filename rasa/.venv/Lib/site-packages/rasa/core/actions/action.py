...
class ActionSessionStart(Action):
    ...
    async def run(
        ...
        if tracker.has_session_started_for_current_message(
            domain.session_config.expiration_time_minutes()
        ):
            structlogger.debug(
...
class ActionSendAgentUpdate(Action):
    """Sends a text message to the output channel."""

    def name(self) -> Text:
        return ACTION_AGENT_SEND_TEXT_UPDATE
