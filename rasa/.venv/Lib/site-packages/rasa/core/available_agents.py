...
class AgentConfiguration(BaseModel):
    ...
    push_notification_url: Optional[str] = Field(default=None, min_length=1)
    # Dotted import path to a call-time credential hook for outbound A2A calls.
    # Its returned OutboundCallResult metadata is merged into Message.metadata.
...
class AgentMCPServerConfig(BaseModel):
    ...
    # Call-time credential hook import path (resolved from endpoints)
    pre_call_hook: Optional[str] = None
