...
PARENT_FLOW_ID_METADATA_KEY = "parent_flow_id"
PARENT_STEP_ID_METADATA_KEY = "parent_step_id"
...
BOT_UTTERANCE_AGENT_NAME_KEY = "agent_name"
BOT_UTTERANCE_AGENT_MESSAGE_TIMESTAMP_KEY = "agent_message_timestamp"
BOT_UTTERANCE_AGENT_MESSAGE_TYPE_KEY = "agent_message_type"
BOT_UTTERANCE_AGENT_MESSAGE_TYPE_INPUT_REQUIRED = "input_required"
BOT_UTTERANCE_AGENT_MESSAGE_TYPE_FINAL_RESPONSE = "final_response"
BOT_UTTERANCE_AGENT_MESSAGE_TYPE_INTERMEDIATE_MESSAGE = "intermediate_message"
# metadata keys for LLM observability (used in BotUttered.metadata and in
# UserUttered.parse_data prompt entries)
LLM_TIME_TO_FIRST_TOKEN_MS_KEY = "llm_time_to_first_token_ms"
LLM_TOTAL_TIME_MS_KEY = "llm_total_time_ms"
# A2A-specific metadata keys for bot utterance events generated by agents
BOT_UTTERANCE_MESSAGE_ID_KEY = "agent_message_id"
BOT_UTTERANCE_CONTEXT_ID_KEY = "agent_context_id"
BOT_UTTERANCE_AGENT_TASK_ID_KEY = "agent_task_id"
...
# Internal ``UserMessage.metadata`` key: stripped before ``UserUttered`` is logged.
A2A_CLIENT_SLOT_COMMANDS_METADATA_KEY = "a2a_client_slot_commands"
RASA_A2A_INPUT_CHANNEL = "a2a"
