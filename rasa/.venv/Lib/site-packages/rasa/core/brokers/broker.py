...
async def _create_from_endpoint_config(
    ...
    elif endpoint_config.type.lower() == "concurrent_kafka":
        from rasa.core.brokers.kafka import ConcurrentKafkaEventBroker

        broker = await ConcurrentKafkaEventBroker.from_endpoint_config(endpoint_config)
    else:
