...
class ContextualResponseRephraser(
    ...
    async def rephrase(
        ...
        Args:
            ...
            output_channel: The output channel used for the interaction.
        ...
        response[LLM_TIME_TO_FIRST_TOKEN_MS_KEY] = (
            llm_response.llm_time_to_first_token_ms
        )
        response[LLM_TOTAL_TIME_MS_KEY] = (
            llm_response.latency * 1000 if llm_response.latency is not None else None
        )
