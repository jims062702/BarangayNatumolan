...
class DefaultV1RecipeValidator(GraphComponent):
    ...
    def _warn_if_some_training_data_is_unused(
        ...
        Args:
            training_data: The training data for the NLU components.
        """
        if training_data.response_examples and (
            ResponseSelector is None or ResponseSelector not in self._component_types
        ):
            response_selector_name = (
                ResponseSelector.__name__ if ResponseSelector else "ResponseSelector"
            )
