...
@hookspec
def after_prediction_loop_end(tracker: "DialogueStateTracker") -> None:
    """Hook specification for after the prediction loop has ended.

    Called after the ``BotTurnEnded`` event has been pushed to the tracker,
    so subscribers receive the final tracker state including turn-level
